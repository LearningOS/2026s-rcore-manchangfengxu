...
impl Ord for StrideTask {
    fn cmp(&self, other: &Self) -> Ordering {
        // BinaryHeap pops the maximum element. We want the minimum stride.
        // Compare strides with overflow-safe technique:
